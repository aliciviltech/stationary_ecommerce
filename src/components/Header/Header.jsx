    ...
    return (
        <div className={`Header relative w-[95%] z-10 mb-10 sm:mb-0 max-w-[1400px] mx-auto h-16  flex items-center justify-between sm:px-10`}>
            ...
            <div className="search">
                <input className='absolute top-20 left-0 w-full  sm:static sm:w-fit sm:mx-0  px-2 py-3 sm:py-0 bg-slate-100 rounded-lg' type="text" placeholder='Search' onChange={(e)=>setSearchInput(e.target.value)} />
            </div>
